...
export const TOOLS: Tool[] = [
  {
    ...
    description: 'Search Austrian statutes and regulations by keyword. Uses FTS5 with BM25 ranking.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Build a comprehensive set of citations for a legal question across Austrian statutes.',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Austrian statute identifier' },
  ...
  },
  {
    ...
    description: 'Find Austrian statutes implementing a specific EU directive or regulation.',
    inputSchema: {
      type: 'object',
      properties: {
